...
export default function Dashboard() {
  ...
  return (
    <div className="content-wrapper" >
      ...
      <div className="row"  style={{ padding: "0px 30px 30px 30px" }}>
        <div style={{ alignItems: "center" }} className="col-xl-12 grid-margin stretch-card font-weight-bold">Số users theo dõi kênh:</div>
        <div className="col-xl-12 grid-margin stretch-card" style={{ justifyContent:"center" }}>
          <Follow />
        </div>
      </div>
